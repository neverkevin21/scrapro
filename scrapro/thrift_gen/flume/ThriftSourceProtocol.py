...
append_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'event', [ThriftFlumeEvent, None], None, ),  # 1
)
...
class appendBatch_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(appendBatch_args)
appendBatch_args.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'events', (TType.STRUCT, [ThriftFlumeEvent, None], False), None, ),  # 1
)
...
class appendBatch_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(appendBatch_result)
appendBatch_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
